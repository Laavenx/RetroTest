...
#include "RTAT_PLayMontageAndWaitForEvent.generated.h"
 ...
 */
UCLASS()
class RETROTEST_API URTAT_PLayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()

public:
	// Constructor and overrides
	URTAT_PLayMontageAndWaitForEvent(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	static URTAT_PLayMontageAndWaitForEvent* PlayMontageAndWaitForEvent(
